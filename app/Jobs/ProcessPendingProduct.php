    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $prompt = "You are a ruthless, highly skeptical technology appraiser AND data architect for a premium comparison website.\n"
                ...
                . "IGNORE RULE A — ACCESSORIES ONLY: Ignore ONLY if the product is clearly one of these:\n"
                . "  - Replacement parts (filters, gaskets, portafilter baskets, cleaning tablets)\n"
                . "  - Accessories (mats, stands, knock boxes, tampers, cups, descaler)\n"
                . "  - Cables, adapters, or carrying cases\n"
                . "  - Multi-item bundles that are NOT a single main device\n"
                . "DO NOT ignore color variants, size variants, or refurbished versions of main devices.\n"
                . "DO NOT ignore a product just because its title is long or contains marketing copy.\n"
                . "If the product IS a main {$category->name} device, you MUST score it.\n"
                . "To ignore, return EXACTLY: " . '{"status": "ignored", "reason": "accessory_or_bundle"}' . "\n\n"
                . "IGNORE RULE B — GENERIC / WHITE-LABEL: Only if the product has NO recognizable brand.\n"
                . "Items from real brands (even budget ones like Chefman, Gevi, Casabrews) are NOT generic.\n"
